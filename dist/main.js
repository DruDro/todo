...
var db = "http://".concat(window.location.hostname, ":16548/api/");
...
var request = function request(url) {
  ...
  return fetch("".concat(db).concat(url), options).then(function (res) {
    return res.json();
  }).catch(function (err) {
    console.log('DB connection is not okay');
  });
};
...
var _propTypes2 = __webpack_require__(2);
...
var _mergeClassNames = __webpack_require__(12);
...
var _locales = __webpack_require__(176);
...
var _Tablink = __webpack_require__(252);

Object.keys(_Tablink).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
...
var _TabNav = __webpack_require__(254);
...
var _Decades = __webpack_require__(266);
...
var _Years = __webpack_require__(268);
...
var _Months = __webpack_require__(270);
...
var _Days = __webpack_require__(272);

var _Days2 = _interopRequireDefault(_Days);

var _Weekdays = __webpack_require__(274);

var _Weekdays2 = _interopRequireDefault(_Weekdays);

var _WeekNumbers = __webpack_require__(275);
...
var Root = React.createElement(_reactRouterDom.BrowserRouter, null, React.createElement(_app.App, null));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createBrowserHistory__ = __webpack_require__(195);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createHashHistory__ = __webpack_require__(197);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_MemoryRouter__ = __webpack_require__(199);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Redirect__ = __webpack_require__(206);
// Written in this round about way for babel-transform-imports
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_history__ = __webpack_require__(207);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createHashHistory__ = __webpack_require__(209);
...
var _pages = __webpack_require__(245);
    ...
    value: function render() {
      ...
      return React.createElement("section", {
        ...
        render: function render() {
          if (_store.store.getState().signin.loggedIn) {
        ...
        render: function render() {
          if (_store.store.getState().signin.loggedIn) {
            ...
            return React.createElement(_pages.Login, {
              updateTitle: _this3.updateTitle
            });
          }
        }
      }), React.createElement(_reactRouterDom.Route, {
        ...
        render: function render() {
          if (_store.store.getState().signin.loggedIn) {
            ...
            return React.createElement(_pages.Register, {
              updateTitle: _this3.updateTitle
            });
          }
        }
        ...
        render: function render() {
          if (_store.store.getState().signin.loggedIn) {
            return React.createElement(_pages.Account, {
              updateTitle: _this3.updateTitle
            });
          } else {
            return React.createElement(_reactRouterDom.Redirect, {
        ...
        render: function render() {
          if (_store.store.getState().signin.loggedIn) {
            return React.createElement(_reactRouterDom.Redirect, {
              to: "/to-dos/".concat(moment().format('D-M-YYYY'))
            });
          } else {
            return React.createElement(_reactRouterDom.Redirect, {
              to: "/login"
        ...
        render: function render(props) {
          if (_store.store.getState().signin.loggedIn) {
            return React.createElement(_pages.Incomplete, _extends({}, props, {
              updateTitle: _this3.updateTitle
            }));
          } else {
            return React.createElement(_reactRouterDom.Redirect, {
        ...
        render: function render(props) {
          if (_store.store.getState().signin.loggedIn) {
            return React.createElement(_pages.Weeks, _extends({}, props, {
              updateTitle: _this3.updateTitle
            }));
          } else {
            return React.createElement(_reactRouterDom.Redirect, {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createStore__ = __webpack_require__(50);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(53), __webpack_require__(231)(module)))
...
var Header = function Header(props) {
  return React.createElement("header", {
    className: "header"
  }, React.createElement(_index.Navigation, {
    title: props.title
  }));
};
...
function (_Component2) {
  ...
  function Navigation() {
    ...
    _this.toggleMenu = function () {
      console.log(_this.state.menuActive);
    ...
    _this.handleClickOutside = function (event) {
      if (_this.refs.menuBtn && !_this.refs.menuBtn.contains(event.target)) {
        _this.setState({
          menuActive: ''
        });
      }
  ...
  _createClass(Navigation, [{
    ...
    key: "render",
    value: function render() {
      var user = _store.store.getState().signin.user;

      return React.createElement("nav", {
        className: "main-nav"
      }, React.createElement("b", {
        className: "logo"
      }, "to_doos"), React.createElement("h1", {
        className: "page-title"
      }, this.props.title), user ? React.createElement("button", {
        ref: "menuBtn",
        className: "btn--menu ".concat(this.state.menuActive),
        onClick: this.toggleMenu
      }, React.createElement("span", null), React.createElement("span", null), React.createElement("span", null)) : '', user ? //if logged in
      React.createElement("ul", null, React.createElement("li", null, React.createElement(_reactRouterDom.NavLink, {
        activeClassName: "active",
        className: "btn",
        to: "/to-dos"
      }, "\u2714", "  My to-dos")), React.createElement("li", null, React.createElement(_reactRouterDom.NavLink, {
        activeClassName: "active",
        className: "btn",
        to: "/to-dos/active"
      }, "\u26AA", "  Active")), React.createElement("li", null, React.createElement(_reactRouterDom.NavLink, {
        activeClassName: "active",
        className: "btn",
        to: "/account"
      }, "\u263A", " ", user.displayName)), React.createElement("li", null, React.createElement(Logout, null))) : '');
    }
  }]);
...
var Footer = function Footer() {
  return React.createElement("footer", {
    ...
    className: "container"
  }, React.createElement("small", null, "\xA9 React To-do by ", React.createElement("a", {
    href: "//github.com/drudro",
    target: "_blank"
  }, "Dru Dro"))));
};
...
Object.defineProperty(exports, "Weeks", {
  enumerable: true,
  get: function get() {
    return _Weeks.Weeks;
  }
});
Object.defineProperty(exports, "Incomplete", {
  enumerable: true,
  get: function get() {
    return _Incomplete.Incomplete;
  }
});
...
var _Weeks = __webpack_require__(246);

var _Incomplete = __webpack_require__(287);

var _Login = __webpack_require__(288);

var _Register = __webpack_require__(289);

var _Account = __webpack_require__(290);
...
var _Weeks = __webpack_require__(247);

Object.keys(_Weeks).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
...
var _Week = __webpack_require__(248);
...
function (_Component) {
  ...
  function Weeks(props) {
    ...
    _this = _possibleConstructorReturn(this, (Weeks.__proto__ || Object.getPrototypeOf(Weeks)).call(this, props));
    _this.title = "My to-dos";
    _this.state = {
  ...
  _createClass(Weeks, [{
    ...
    value: function prevWeek() {
      ...
      var date = moment(window.location.href.substring(window.location.href.lastIndexOf('/') + 1), 'D-M-YYYY');
      this.setState({
        week: week - 1,
      ...
      setTimeout(function () {
        window.history.pushState({}, 'prev', "/to-dos/".concat(_this2.state.date));
    ...
    value: function nextWeek() {
      ...
      setTimeout(function () {
        window.history.pushState({}, 'next', "/to-dos/".concat(_this3.state.date));
    ...
    value: function render() {
      ...
      return React.createElement("section", {
        ...
        className: "week ".concat(this.state.animation),
        ref: function ref(weekNumber) {
          return _this4.weekNumber = weekNumber;
        }
      }, "Week: ".concat(moment().day(1).week(this.state.week).format('D.M.YYYY'), " \u2014 ").concat(moment().day(7).week(this.state.week).format('D.M.YYYY'))), React.createElement("button", {
        title: "Next week",
        onClick: this.nextWeek.bind(this)
      }, "\u21E2"))), React.createElement(_Week.Week, {
...
var _AddTask = __webpack_require__(255);

var _request = __webpack_require__(11);

var _store = __webpack_require__(9);

var _reactDatePicker = _interopRequireDefault(__webpack_require__(258));
...
function (_Component) {
  ...
  function Week(props) {
    ...
    _this = _possibleConstructorReturn(this, (Week.__proto__ || Object.getPrototypeOf(Week)).call(this, props));

    _this.setTab = function () {
      var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : moment(_this.state.date, 'D-M-YYYY').isoWeekday();

      _this.setState({
        tab: id,
        animation: 'animated pulse',
        date: moment().isoWeekday(id).week(_this.state.week).format('D-M-YYYY')
      });

      setTimeout(function () {
        return history.pushState({}, 'date', "".concat(_this.state.date));
      });
      setTimeout(function () {
    ...
    _this.goToDate = function (date) {
      console.log(moment(date).week());

      _this.setTab();

      _this.setState({
        date: "/to-dos/".concat(moment(date).format('D-M-YYYY')),
  ...
  _createClass(Week, [{
    key: "getTasks",
    value: function getTasks(userId) {
      var _this2 = this;

      (0, _request.request)("tasks?userId=".concat(userId)).then(function (tasks) {
        return tasks.reverse().sort(function (task) {
    ...
    value: function deleteTask(task) {
      ...
      if (confirm("Delete this to-do?\n    ".concat(task.title))) {
        (0, _request.request)("tasks/".concat(task.id), "DELETE").then(function () {
          return _this3.getTasks(_this3.state.userId);
        });
      }
    }
  }, {
    key: "updateTask",
    value: function updateTask(task, date) {
      var _this4 = this;

      var form = document.querySelector("#task_".concat(task.id)),
      ...
      if (title.validity.valid) {
        (0, _request.request)("tasks/".concat(task.id), 'PUT', {
          completed: completed,
          ...
          return _this4.getTasks(_this4.state.userId);
        });
      }
    }
  }, {
    key: "setCompleted",
    value: function setCompleted(task, e) {
      var _this5 = this;

      var completed = e.target.checked;
      (0, _request.request)("tasks/".concat(task.id), 'PATCH', {
        completed: completed
      }).then(function () {
        return _this5.getTasks(_this5.state.userId);
      });
    }
  }, {
    key: "componentWillMount",
    value: function componentWillMount() {
      ...
      var userId = _store.store.getState().signin.user.id;
    ...
    value: function render() {
      ...
      return React.createElement(_Tabs.Tabs, {
        active: moment(this.state.date, 'D-M-YYYY').isoWeekday() - 1,
        select: this.setTab
      }, this.days.map(function (day) {
        var date = moment().isoWeekday(day.id).week(_this7.state.week).format('D-M-YYYY'),
            tasks = _this7.state.tasks.filter(function (task) {
          return task.date == date;
        });

        return React.createElement(_Tabs.Tab, {
          key: day.id
        }, React.createElement(_Tabs.Tablink, {
          title: day.title,
          date: date
        }), React.createElement(_Tabs.TabContent, null, React.createElement("div", {
          className: "tasks-date ".concat(_this7.state.animation, " ").concat(_this7.props.animation)
        }, React.createElement(_reactDatePicker.default, {
          onChange: _this7.goToDate,
          value: new Date(moment(_this7.state.date, 'D-M-YYYY').format())
        }), React.createElement("span", {
          className: "selected-date"
        }, moment(_this7.state.date, 'D-M-YYYY').format('D.M.YYYY'))), tasks.length ? React.createElement("ul", {
          className: "task-list"
        }, tasks.map(function (task, index) {
          return React.createElement("li", {
            key: task.id
          }, React.createElement("form", {
            id: "task_".concat(task.id),
            ...
            name: "complete_".concat(task.id),
            id: "complete_".concat(task.id),
            type: "checkbox",
            onChange: function onChange(e) {
              return _this7.setCompleted(task, e);
            },
            defaultChecked: task.completed
          }), React.createElement("label", {
            htmlFor: "complete_".concat(task.id),
            title: "Mark ".concat(task.completed ? 'not completed' : 'completed')
          }), React.createElement("input", {
            type: "text",
            key: "tt_".concat(task.id),
            className: "task-title ".concat(task.completed ? 'completed' : ''),
            defaultValue: "".concat(task.title),
            onBlur: _this7.updateTask.bind(_this7, task, date),
            required: true,
            ...
            className: "hint"
          }, "Title must contain at least 3 characters: latin letters and/or numbers"), React.createElement("textarea", {
            type: "text",
            key: "td_".concat(task.id),
            className: "task-desc",
            ...
            onClick: _this7.deleteTask.bind(_this7, task),
            title: "Delete to-do"
          }, "\u2573")));
        })) : React.createElement("p", {
          className: "center"
        }, "No to-dos yet..."), React.createElement(_AddTask.AddTask, {
          date: date,
          userId: _this7.state.userId,
          getTasks: _this7.getTasks.bind(_this7)
        })));
      }));
    }
  }]);
...
function (_React$Component) {
  ...
  function Tabs(props) {
    ...
    _this.clickTab = function (id) {
      _this.setState({
        id: id
      });

      setTimeout(function () {
        if (_this.props.select) _this.props.select(_this.state.id + 1);
      }, 0);
    };
  ...
  _createClass(Tabs, [{
    ...
    key: "render",
    value: function render() {
      var tabs = this.props.children.filter(function (child) {
        return child.type === _.Tab;
      }).reduce(function (prev, next) {
        return _toConsumableArray(prev).concat(_toConsumableArray(next.props.children));
      }, []); // tabs = [{Tablink}, {TabContent}, {Tablink}, {TabContent}]

      var navList = tabs.filter(function (tab) {
        return tab.type === _.Tablink;
      }); // [{Tablink}, {Tablink}]

      var tabContents = tabs.filter(function (tab) {
        return tab.type === _.TabContent;
      }); // [{TabContent}, {TabContent}]

      return React.createElement("div", {
        className: "tabs"
      }, React.createElement(_.TabNav, {
        select: this.clickTab,
        activeIndex: this.state.id
      }, navList), tabContents[this.state.id]);
    }
  }]);
...
var TabNav = function TabNav(_ref) {
  ...
  return React.createElement("nav", {
    className: "nav-tab"
  }, React.createElement("ul", null, children.map(function (el, index) {
    var Tablink = el.type;
    return React.createElement("li", {
      className: activeIndex === index ? 'active' : '',
      key: index
    }, React.createElement(Tablink, _extends({}, el.props, {
      select: select,
      index: index
    })));
  })));
...
function (_Component) {
  ...
  function AddTask(props) {
    ...
    _this = _possibleConstructorReturn(this, (AddTask.__proto__ || Object.getPrototypeOf(AddTask)).call(this, props));
    _this.state = {
      toggleAddTaskPopup: "hidden"
    };
    return _this;
  }
  ...
  _createClass(AddTask, [{
    ...
    value: function addTask() {
      ...
      (0, _request.request)('tasks', 'POST', {
        ...
        return _this2.props.getTasks(_this2.props.userId);
      }).then(function () {
        return form.reset();
      }).then(function () {
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: "btn--wide btn--round",
        onClick: this.togglePopup.bind(this)
      }, "Add todo")), React.createElement("div", {
        className: "".concat(this.state.toggleAddTaskPopup, " popup")
      }, React.createElement("button", {
      ...
      }, React.createElement("fieldset", null, React.createElement("legend", null, "Add To-Do"), React.createElement("div", {
        className: "container"
      }, React.createElement("label", {
        htmlFor: ""
      }, "To-do"), React.createElement("input", {
        type: "text",
        id: "title",
        required: true,
        placeholder: "Title",
        ...
        htmlFor: ""
      }, "To-do description"), React.createElement("textarea", {
        type: "text",
        id: "description",
...
var _detectElementOverflow = __webpack_require__(261);

var _detectElementOverflow2 = _interopRequireDefault(_detectElementOverflow);

var _entry = __webpack_require__(262);

var _entry2 = _interopRequireDefault(_entry);

var _DateInput = __webpack_require__(277);
...
var _Calendar = __webpack_require__(263);

var _Calendar2 = _interopRequireDefault(_Calendar);

var _CenturyView = __webpack_require__(177);

var _CenturyView2 = _interopRequireDefault(_CenturyView);

var _DecadeView = __webpack_require__(178);

var _DecadeView2 = _interopRequireDefault(_DecadeView);

var _YearView = __webpack_require__(179);

var _YearView2 = _interopRequireDefault(_YearView);

var _MonthView = __webpack_require__(180);
...
var _dateFormatter = __webpack_require__(33);
...
var _TileGroup = __webpack_require__(22);

var _TileGroup2 = _interopRequireDefault(_TileGroup);

var _Decade = __webpack_require__(267);
...
var _Tile = __webpack_require__(23);
...
var _Month = __webpack_require__(271);
...
var _Day = __webpack_require__(273);
...
var _WeekNumber = __webpack_require__(276);
...
var _DayInput = __webpack_require__(279);

var _DayInput2 = _interopRequireDefault(_DayInput);

var _MonthInput = __webpack_require__(280);

var _MonthInput2 = _interopRequireDefault(_MonthInput);

var _YearInput = __webpack_require__(281);

var _YearInput2 = _interopRequireDefault(_YearInput);

var _NativeInput = __webpack_require__(282);

var _NativeInput2 = _interopRequireDefault(_NativeInput);

var _dateFormatter = __webpack_require__(283);

var _dates = __webpack_require__(17);

var _propTypes3 = __webpack_require__(18);
...
var _locales = __webpack_require__(284);
...
/*#__PURE__*/
function (_Component) {
  _inherits(Incomplete, _Component);

  function Incomplete() {
    var _this;

    _classCallCheck(this, Incomplete);

    _this = _possibleConstructorReturn(this, (Incomplete.__proto__ || Object.getPrototypeOf(Incomplete)).call(this));
    _this.title = "Active to-dos";
    _this.state = {
      tasks: [],
      userId: null
    };
  ...
  _createClass(Incomplete, [{
    key: "getTasks",
    value: function getTasks() {
      var _this2 = this;

      var userId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.state.userId;
      (0, _request.request)("tasks?userId=".concat(userId)).then(function (tasks) {
        return tasks.reverse().filter(function (task) {
    ...
    value: function render() {
      ...
      if (tasks.length) {
        return React.createElement("ul", {
          className: "task-list incomplete"
        }, tasks.map(function (task, index) {
          return React.createElement("li", {
            key: task.id
          }, React.createElement("form", {
            ...
            type: "checkbox",
            onChange: function onChange(e) {
              return _this6.setCompleted(task, e);
            },
            defaultChecked: task.completed
          }), React.createElement("label", {
            htmlFor: "complete_".concat(task.id),
            ...
            className: "task-title ".concat(task.completed ? 'completed' : ''),
            defaultValue: "".concat(task.title),
            onBlur: _this6.updateTask.bind(_this6, task),
            required: true,
            placeholder: "Task title",
            maxLength: "80",
            minLength: "3",
...
function (_Component) {
  ...
  function Login(props) {
    ...
    _this.login = function (form) {
      ...
      (0, _request.request)("users?login=".concat(login, "&password=").concat(password)).then(function (user) {
        if (user) {
          _store.store.dispatch({
            type: 'LOG_IN',
            user: user[0]
          ...
          setTimeout(function () {
            return form.classList.remove('animated', 'shake');
          }, 300);
        }
      });
    };
...
function (_Component) {
  ...
  _createClass(Register, [{
    ...
    value: function register(form) {
      ...
      (0, _request.request)('users').then(function (users) {
        return users.filter(function (user) {
          return user.login === login;
        });
      }).then(function (users) {
        if (!users.length) {
          (0, _request.request)('users/', 'POST', {
            createdAt: moment().format('D-M-YYYY'),
          ...
          alert("A user with login \"".concat(login, "\" already exists"));
        }
      });
    }
  }, {
...
function (_Component) {
  ...
  function Account(props) {
    ...
    _this = _possibleConstructorReturn(this, (Account.__proto__ || Object.getPrototypeOf(Account)).call(this, props));
    _this.title = "Account";
    return _this;
  }
  ...
  _createClass(Account, [{
    ...
    value: function update(form) {
      var oldPassword = document.querySelector('#password').value,
          newPassword = document.querySelector('#newPassword').value,
          displayName = document.querySelector('#displayName').value;

      if (oldPassword === _store.store.getState().signin.user.password) {
        (0, _request.request)("users/".concat(_store.store.getState().signin.user.id), 'PATCH', {
          displayName: displayName,
    ...
    value: function render() {
      ...
      return React.createElement("form", {
        ...
        maxLength: "40",
        minLength: "3",
        defaultValue: _store.store.getState().signin.user.displayName
      }), React.createElement("label", {
        htmlFor: ""
